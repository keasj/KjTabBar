...
```powershell
.\tools\Prepare-Release.ps1 -Version '1.3.8.0'
```

Output: `artifacts/releases/v1.3.8.0/`, outside the setup build output directories.

- `ja/setup.exe` + `ja/Setup.msi`, and the corresponding `KjTabBar-v1.3.8.0-ja.zip`.
- `en/setup.exe` + `en/Setup.msi`, and the corresponding `KjTabBar-v1.3.8.0-en.zip`.
...
- `KjTabBar-v1.3.8.0-ja.zip`
- `KjTabBar-v1.3.8.0-en.zip`
- `SHA256SUMS.txt`
