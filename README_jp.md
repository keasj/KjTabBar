...
- **ドラッグ＆ドロップ対応**
  ...
  - タブバー非表示のエクスプローラーウィンドウをドラッグし、既存のタブバーの上に重ねてドロップすることで、そのフォルダを新しいタブとして吸収・統合する
...
4. **タブの操作**:
   ...
   - タブバーの表示されていない独立したエクスプローラーウィンドウをドラッグして、既存のタブバー上に重ねてドロップすることで、そのエクスプローラーを現在のタブバーへ吸収・合流させることができます。
5. **設定**:
